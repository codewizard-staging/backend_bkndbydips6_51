package com.app.bkndbydips6.integrationtest;
...
import com.app.bkndbydips6.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("bkndbydips6", n.getAttribute("Namespace"));
  ...
  void  testCreateOrganizationInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips6/Organizations")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips6/Organizations?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/bkndbydips6/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips6/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips6/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydips6/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips6/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips6/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydips6/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM bkndbydips6.Organization");
    jdbcTemplate.execute("DELETE FROM bkndbydips6.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM bkndbydips6.EmlpoyeeProfile");
